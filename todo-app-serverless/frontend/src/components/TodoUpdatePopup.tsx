...
import { TodoForm, Todo } from '../interfaces/todoInterface'
...
const TodoUpdatePopup: React.FC<TodoUpdatePopupProps> = ({ showPopup, setShowPopup, updateTodo, todoToUpdate }) => {
  ...
  const handleUpdateTodo = (e: FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    console.log('This is todo to update: ', todoToUpdate)
      ...
      <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div className="bg-white p-8 rounded-md shadow-md">
          ...
          <form onSubmit={handleUpdateTodo}>
            ...
            <button type="submit" className="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 shadow-sm">
              Update Todo
            </button>
            <button
